...
<html>
    <head>
        ...
        <?php include('search.php'); include('searchartiste.php'); include('searchevent.php'); 
              ...
              $artved = requete_artiste('{"query":{"bool":{"must":[],"must_not":[],"should":[{"query_string":{"default_field":"artist.title","query":""}},{"query_string":{"default_field":"artist.body","query":"Figuratif"}}]}},"from":0,"size":3,"sort":[],"facets":{}}');
        ?>
        ...
        <div id="bloc_page">
           ...
           <br>
             ...
             <div id="artist_left">
                   ...
                   <div id="search_form">
                    <form name="FormAll">
                      <label> Artiste :</label><br><input type="text" id="tags1" ><br>
                        <a class="js-open-modal" href="#" data-modal-id="popup1"  style="color:#01648b;display: block; float: right; margin: 10px;font-size: 11px;"> Liste des Artistes</a>
                      ...
                      <br><label> Type d'oeuvre :</label><br>
                                            ...
                                            <select class="select1" id="style"><option></option>
                                             ...
                                             <option>Figuratif</option>
                                             <option>Abstrait</option>
                                             <option value="naif">Naif/Primitif</option></select><br><br>

                       <div id="Autres">                      
                      <label>Prix :</label><br>
                      <select class="select1" id="prix1">
                      <option></option>
                        <option value="3000 à 10 000 DH">3000 à 10 000 DH</option>
                        <option value="10 001 à 50 000 DH">10 001 à 50 000 DH</option>
                        <option value="50 001 à 150 000 DH">50 001 à 150 000 DH</option>
                        <option value="150 001 DH et + ">150 001 DH et +</option>
                      </select><br><br>
                      </div>
               ...
               <br><br>
                  <div id="btn_suggestions" style="background-color:#01648B;"><a href="#">Les suggestions de vosartistes.com >></a></div>
                 ...
                 <br>
                  ...
                  <div class="artistarticle">
                    ...
                    <div class="seagreen" style="background-color:#8A1527"><span>Artistes Vedettes</span></div>
                    ...
                    echo '<a href="artiste.php?artiste='.$p.'">';
                        echo'<div class="artistes-slidbar">';
                          echo'<h2>'.$p.'</h2>';
             ...
             <div style="float: right; margin-right: 20px;">
              ...
              <div id="h1-id" align="center"><h1><?php echo body_title_oeuvre($oeuvre); ?></h1> </div>
                ...
                <?php $p = pubData_oeuvre($oeuvre);
                    if($p[0] != '') echo 'Artiste : <span>'.$p[0].'</span><br><br>';
                    if($p[1] != '') echo 'Matériaux : <span>'.$p[1].'</span><br><br>';
                    if($p[2] != '') echo 'Support : <span>'.$p[2].'</span><br><br>';
                    if($p[3] != '') echo 'Format : <span>'.$p[3].'</span><br><br>';
                    if($p[4] != '') echo 'Style : <span>'.$p[4].'</span><br><br>';
                    if($p[5] != '') echo 'Année d\'exécution : <span>'.$p[5].'</span><br><br>';
                    if($p[6] != '') echo 'Prix : <span>'.$p[6].'</span><br><br>';
                    if($p[7] != '') echo 'Conversion : <span>'.$p[7].'</span><br><br>';
                    if($p[8] != '') echo 'Référence : <span>'.$p[8].'</span><br><br>';
                    ?>
                </div>
                 ...
                 <h3>Ses Oeuvres</h3>
                      ...
                      <?php 
                          ...
                          for($i=0; $i<$result['hits']['total'] ; $i++ ){
                            ...
                            echo'<div><h3><a href='.$aid.' class="zoombox zgallery1" title="oeuvre.php?artiste='.$p[0].'&oeuvre='.ID($result,$i).'&type='.Type($result,$i).'+'.$p[8].'" ><img src='.$imgs[count($imgs)-1].' ></a></h3></div>';
                          }
                      ?>
