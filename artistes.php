             ...
             <div id="artist_left">
                 ...
                 <div id="search_per">
                  <div id="search_titre">Personnalisez votre recherche</div>
                   <div id="search_form">
                   <form name="FormAll">
                       <label> Artiste :</label><input type="text" id="tags1" >
                      ...
                      <label> Type d'oeuvre :</label><br>
                                            ...
                                            <select class="select2" id="style"><option></option>
                                             ...
                                             <option>Figuratif</option>
                                             <option>Abstrait</option>
                                             <option value="naif" >Naif/Primitif</option></select>
                      ...
                      <div class="col-lg-4">
                        <div class="liste no">
                          <ul>
                              ...
                              <li><i class="fa fa-envelope"></i><a href="mailto:vosartistes.com@gmail.com">  Nous écrire</a></li>
...
<br>
                ...
                <div id="fmobil" style="background:#8A1527">
                  <div class="liste no">
                          <ul>
                              <li><i class="fa fa-phone"></i><a href="tel:+212.6.60.15.94.94"> +212.6.60.15.94.94</a></li>
                              <li><i class="fa fa-envelope"></i><a href="mailto:vosartistes.com@gmail.com">  Nous écrire par e-mail</a></li>
                              <li><i class="fa fa-fax"></i> <a href="tel:+212.5.22.94.24.13">+212.5.22.94.24.13</a></li>
                          </ul>
                  </div>
        ...
        // nameart = $("#tags1").val();
            ...
            function(data){  $( "#artist_right" ).html(data);
                $(".tableaux").on({
                    mouseenter: function () {
                        //$(this).addClass("hover");
                        $( this ).children(".tableaux_detail").addClass( "visible" );
                    },
                    mouseleave:function () {
                        //$(this).removeClass("hover");
                        $( this ).children(".tableaux_detail").removeClass( "visible" );
                    }
                });
            }, 'html' );
    });
  ...
  $(window).scroll(function() { //detect page scroll
    ...
    if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
    {
      ...
      if(track_load <= total && loading==false) //there's more data to load
      {
        ...
        $.post('autoload_artistes.php',{'group_no': track_load}, function(data){
