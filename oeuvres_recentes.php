...
<br><br>
             ...
             <div id="artist_right">
                <?php 
                 ...
                 $result = requete_nouveautes('{"query":{"bool":{"must":[{"wildcard":{"nouveau.title":"*"}}],"must_not":[{"wildcard":{"nouveau.title":"*découvertes"}}],"should":[]}},"from":0,"size":8,"sort":[{"@timestamp":{"order":"desc"}}],"facets":{}}');
                  $i = 0;
...
$(".liste").click(function(){
  ...
  ///////////////////////////////////////////////////////////////////////////////////////
  var track_load = 5; //total loaded record group(s)
  ...
  $(window).scroll(function() { //detect page scroll
    ...
    if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
    {
      ...
      if(track_load <= total && loading==false) //there's more data to load
      {
        ...
        $.post('autoload_oeuvres_recentes.php',{'group_no': track_load}, function(data){
