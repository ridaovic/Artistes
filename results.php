...
<html>
    <head>
        ...
        <script src="js/autocomplete_arTags1.js"></script>
							...
							<div class="btn-group">
							  <div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="javascript:;" title="French" class="translator-language-fr"><img src="translator/images/French.gif" alt="French" />Fr</a></li>
									<li><a href="javascript:;" title="English" class="translator-language-en"><img src="translator/images/English.gif" alt="English" />En</a></li>
									<li><a href="javascript:;" title="Spanish" class="translator-language-es"><img src="translator/images/Spanish.gif" alt="Spanish" />Es</a></li>
									<li><a href="javascript:;" title="Arabic" class="translator-language-ar"><img src="translator/images/Arabic.gif" alt="Arabic" />Ar</a></li>
								</ul>
          ...
          <div id="myCarouselMini" class="carousel slide" data-ride="carousel">
             ...
             <?php 
				 ...
				 switch($form){
					 case "aaa":
					 //echo $search_a_o;
					 $result = requeteAll('{"query":{"bool":{"must":[],"must_not":[],"should":[{"query_string":{"default_field":"title","query":"*'.$search_a_o.'*"}},{"query_string":{"default_field":"body","query":"*'.$search_a_o.'*"}}]}},"from":0,"size":64,"sort":[],"facets":{}}');  
					 //$result = requete('{"query":{"bool":{"must":[],"must_not":[],"should":[{"query_string":{"default_field":"artist.title","query":""}},{"query_string":{"default_field":"artist.body","query":"Figuratif"}}]}},"from":0,"size":10,"sort":[],"facets":{}}');                
	                  $i = 0;
...
$(document).ready(function() {
 ...
 $("#tags1").focusout(function(){
        ...
        // nameart = $("#tags1").val();
            ...
            if (selectTypeOeuvre=="All" && selectstyle=="" && nameart=="") {
              scl=true;
  ...
  $(window).scroll(function() { //detect page scroll
    ...
    if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
    {
      ...
      if(track_load <= total && loading==false) //there's more data to load
      {
        ...
        $.post('autoload_all.php',{'group_no': track_load}, function(data){
  ...
  $(window).scroll(function() { //detect page scroll
    ...
    if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
    {
      ...
      if(track_load <= total && loading==false) //there's more data to load
      {
        ...
        //load data from the server using a HTTP POST request
        $.post('autoload_artistes_responsive.php',{'group_no': track_load}, function(data){
