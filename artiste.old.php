...
<html>
    ...
    include('searchartiste.php');
              ...
              $oeuvretend = requete('{"query":{"bool":{"must":[{"query_string":{"default_field":"parentUrl","query":"tendance"}}],"must_not":[],"should":[{"query_string":{"default_field":"_all","query":"tendance"}}]}},"from":0,"size":3,"sort":[],"facets":{}}');
                   ...
                   <div id="search_form">
                      ...
                      <label> Artiste :</label><br>
                       <input type="text" id="tags1">
                        <a class="js-open-modal" href="#" data-modal-id="popup1"  style="font-size: 11px;color :#8a1527;display: block; float: right; margin: 10px;"> Liste des Artistes</a>
                 ...
                 <div class="artistarticle">
                    ...
                    for($i=0;$i<3;$i++){
                      ...
                      echo'<div class="oeuvre">';
                        echo'<div class="oeuvre_img"><img src="'.$imgs[count($imgs)-1].'" width="120" height="90"></div>';
                          echo'<div class="oeuvre_detail"><strong>&ldquo;'.$p[0].'&rdquo;</strong><br>'.$title.'</div>';
                          echo'<div class="oeuvre_plus"><a class="textdeco" href="oeuvre.php?artiste='.$p[0].'&oeuvre='.ID($oeuvretend,$i).'&type='.Type($oeuvretend,$i).'">+</a></div>';
                      echo'</div>';
                      if($i<2) echo'<hr style="background: none repeat scroll 0 0 #01648B;height: 2px;width: 200px;">';
                    }
                      ?>
